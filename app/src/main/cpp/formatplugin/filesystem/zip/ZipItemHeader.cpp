...
const int ZipItemHeader::SIGNATURE_LOCAL_FILE = 0x02014B50;
const int ZipItemHeader::SIGNATURE_DATA = 0x04034B50;
const int ZipItemHeader::SIGNATURE_CENTRAL_DIRECTORY = 0x06054B50;
const int ZipItemHeader::SIGNATURE_END_OF_CENTRAL_DIRECTORY = 0x08074B50;
...
bool ZipHeaderDetector::readItemHeader(InputStream &stream, ZipItemHeader &header) {
    ...
    switch (header.signature) {
        ...
        case ZipItemHeader::SIGNATURE_CENTRAL_DIRECTORY: { // 如果是目录
            ...
            return stream.offset() == startOffset + 42 + header.nameLength + header.extraLength + toSkip;
        }
