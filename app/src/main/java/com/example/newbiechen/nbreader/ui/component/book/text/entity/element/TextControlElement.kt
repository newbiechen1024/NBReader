...
data class TextControlElement(
    ...
    companion object {
        ...
        fun get(styleType: Byte, isStart: Boolean): TextControlElement {
            // 根据 start 决定数组类型
            ...
            var element: TextControlElement? = elements[styleType.toInt() and 0xFF]

            // 如果 element 不存在
            if (element == null) {
                // 创建一个 element
                element = TextControlElement(styleType, isStart)
                elements[styleType.toInt() and 0xFF] = element
            }
